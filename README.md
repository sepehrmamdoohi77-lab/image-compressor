...
بخش ویدیو فرمت‌های رایج ورودی را با FFmpeg می‌خواند و خروجی MP4، WEBM، MOV، MKV و AVI تولید می‌کند. برای پردازش آن وابستگی `imageio-ffmpeg` نصب می‌شود. حجم مجاز ویدیو ۲۰۰ مگابایت است.
